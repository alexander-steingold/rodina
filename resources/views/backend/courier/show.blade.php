<x-admin-layout title="{{ __('general.courier.courier_profile') }}">
    <div
        class="grid lg:gap-6 lg:grid  {{ __('general.courier.courier_profile') }}cols-2  sm:grid-cols-2 sm:mb-4 xs:mb-4">
        <div>
    ...
    <div class="grid gap-6 lg:grid-cols-3 ">
        ...
        <div>
            ...
            <x-backend.sidebar-events :events="$courier->events"/>
        </div>
    </div>
</x-admin-layout>
