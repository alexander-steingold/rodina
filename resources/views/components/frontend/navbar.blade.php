    ...
    <nav class="navbar navbar-area-2 navbar-area navbar-expand-lg">
        <div class="container nav-container">
            ...
            <div class="logo">
                ...
                <a class="logo-1" href="{{ route('index') }}"><img
                        src="{{ asset('landing/assets/img/home-2/logo.png') }}"
                        alt="img"></a>
                <a class="logo-2" href="{{ route('index') }}"><img
                        src="{{ asset('landing/assets/img/home-2/logo-2.png') }}"
                        alt="logo"></a>
            </div>
