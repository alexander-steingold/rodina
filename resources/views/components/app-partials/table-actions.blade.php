<div x-data="usePopper({ placement: 'bottom-end', offset: 4 })"
    ...
    <button type="button" x-ref="popperRef" @click="isShowPopper = !isShowPopper"
            class="btn h-6 w-6  p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
